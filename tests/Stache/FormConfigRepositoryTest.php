...
class FormConfigRepositoryTest extends TestCase
{
    ...
    private function setUpSingleSite()
    {
        ...
        $this->directory = __DIR__.'/__fixtures__/resources/hubspot';
        $stache->registerStore((new FormConfigStore)->directory($this->directory));
    ...
    private function setUpMultiSite()
    {
        ...
        $this->app->instance(Stache::class, $stache);
        $this->directory = __DIR__.'/__fixtures__/resources/hubspot-multisite';
        $stache->registerStore((new FormConfigStore)->directory($this->directory));
    ...
    public function it_saves_a_form_config_to_the_stache_and_to_a_file_with_single_site()
    {
        ...
        $this->assertEquals(['email_field' => 'email'], [
